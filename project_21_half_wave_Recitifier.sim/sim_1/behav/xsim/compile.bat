...
REM
REM Generated by Vivado on Wed Jan 14 14:08:46 -0800 2026
...
echo "xvlog --incr --relax -prj tb_HalfWaveROM_vlog.prj"
call xvlog  --incr --relax -prj tb_HalfWaveROM_vlog.prj -log xvlog.log
